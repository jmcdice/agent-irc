...
<Dialog>
  ...
  <DialogContent>
    ...
    Content here
      ...
      <ComponentCard
        title="Alert Dialog"
        description="A modal for important confirmations that require user action."
...
<AlertDialog>
  ...
  <AlertDialogContent>
    ...
    <AlertDialogFooter>
      ...
      <ComponentCard
        title="Sheet"
        description="A slide-out panel for secondary content."
...
<Sheet>
  ...
  <SheetContent>
    ...
    Content here
      ...
      <ComponentCard
        title="Dropdown Menu"
        description="A menu that appears on click with action items."
